      ...
      <Tabs defaultValue="resources" className="flex min-h-0 flex-1 flex-col">
        ...
        <TabsContent value="assignments">
          ...
          <Card className="p-4">
            <div className="max-h-[320px] overflow-auto">
              <table className="w-full whitespace-nowrap text-[11px]">
                <thead><tr className="text-left text-[10px] uppercase text-[#64748B]"><th className="py-2">Resource</th><th>Client</th><th>Service</th><th>Package</th><th>From</th><th>To</th><th>Monthly Fee ($)</th><th>Rev Share (INR)</th><th>Util %</th><th>Status</th></tr></thead>
                <tbody>
