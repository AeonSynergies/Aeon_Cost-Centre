...
import { PageShell, Stat } from "@/components/shell/PageShell";
...
import { ResourceAddModal } from "@/components/modals/ResourceAddModal";
...
export default function ResourcesPage() {
  ...
  return (
    ...
    >
      ...
      <ResourceAddModal open={addOpen} onOpenChange={setAddOpen} onSaved={() => mutate()} />
    </PageShell>
  );
}
